...
namespace WindowsFormsApp2
{
    public partial class FormUserManegement : Form, IReminderObserver
    {
        ...
        private void FormUserManegement_Load(object sender, EventArgs e)
        {
            ...
            // NotesManager sütunu varsa gizle
            if (usersDataGridView.Columns.Contains("NotesManager"))
            {
                usersDataGridView.Columns["NotesManager"].Visible = false;
            }
            
            // PhoneBook sütunu varsa görünür yap
            if (usersDataGridView.Columns.Contains("PhoneBook"))
            {
                usersDataGridView.Columns["PhoneBook"].Visible = true;
            }
        }
        ...
        private void btn_güncelle_Click(object sender, EventArgs e)
        {
            ...
            if (selectedRowIndex >= 0)
            {
                ...
                usersDataGridView.Rows[selectedRowIndex].Cells["EmailAddress"].Value = emailTextBox.Text;
                usersDataGridView.Rows[selectedRowIndex].Cells["UserPassword"].Value = passwordTextBox.Text;
                usersDataGridView.Rows[selectedRowIndex].Cells["ContactNumber"].Value = phoneNumberTextBox.Text;
        ...
        private async void btnSendMail_Click(object sender, EventArgs e)
        {
            ...
            if (IsValidEmail(email))
            {
                ...
                try
                {
                    ...
                    String mailadresi = ConfigurationManager.AppSettings["MailAddress"]; // Gmail hesabınızı buraya girin
                    String mailfresifre = ConfigurationManager.AppSettings["MailPassword"]; // Google hesabınızdan aldığınız 16 haneli uygulama şifresini buraya girin
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0 && e.RowIndex < usersDataGridView.Rows.Count)
            {
                ...
                emailTextBox.Text = selectedRow.Cells["EmailAddress"].Value.ToString();
                passwordTextBox.Text = selectedRow.Cells["UserPassword"].Value.ToString();
                phoneNumberTextBox.Text = selectedRow.Cells["ContactNumber"].Value.ToString();
